...
with Diagram("Container Diagram for CRM/LXRMS System", direction="TB", graph_attr=graph_attr):
    ...
    facturation_service >> Relationship("Sends: SecurityAlertEvent, SecurityUpdateEvent") >> event_bus
    ...
    facturation_service << Relationship("Consumes: SecurityAlertEvent, SecurityUpdateEvent") << event_bus
